...
class WooCommerceClient:
    def __init__(self):
        """Create the HTTP client used for live WooCommerce requests."""
    ...
    async def list_all_products(self) -> list[Product]:
        ...
        while True:
            ...
            log.debug("woo_pagination_progress", page=page, fetched_so_far=len(all_products))
    ...
    async def _get(
        ...
        try:
            ...
            if response.status_code == 404:
                raise WooCommerceNotFoundError(f"WooCommerce endpoint not found: {endpoint}")
